...
const RegisterOtpVerification = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <CustomText style={styles.title}>{t('verification') || 'Verification'}</CustomText>
        <CustomText style={styles.subTitle}>{t('codeHasBeenSentTo') || 'Code has been sent to'} {phoneNumber}</CustomText>
